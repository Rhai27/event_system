...
<head>
    ...
    <link rel="stylesheet" href="css/mid_role_add_event.css">
...
<body>
    ...
    <div class="nav_bar">
        ...
        <div class="form_container">
            <form action="includes/mid_role_add_event_process.php" method="post">
                <div class="form_d5">
                    <div class="form_d1">
                        <div class="form_d2">
                    ...
                    <div class="form_d4">
                        ...
                        <input type="hidden" id="qevent_status" name="qevent_status" value="Pending">
