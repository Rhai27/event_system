                        ...
                        <div class="form_d5">
                            <div class="form_d1">
                                <div class="form_d2">
                                    ...
                                    <input type="text" id="title" name="title"
                                        value="<?php echo $eventData['title']; ?>" required>
                                </div>

                                <div class="form_d3">
                                    <label for="date">Event Date:</label>
                                    <input type="date" id="date" name="date"
                                        value="<?php echo $eventData['date']; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form_d4">
                                ...
                                <input type="text" id="location" name="location"
                                    value="<?php echo $eventData['location']; ?>" required>

                                <label for="description">Event Description:</label>
                                <textarea id="description" name="description" rows="4"
                                        cols="50" required><?php echo $eventData['description']; ?></textarea>
                                
                                <?php if ($eventData['qevent_status'] === "Cancelled"): ?>
