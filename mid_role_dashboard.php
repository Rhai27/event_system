...
if (isset($_POST['cancel_event'])) {
    ...
    header("Location: specify_reason.php?event_id=$eventId");
    exit();
}
            ...
            <?php
                try {
                    ...
                    foreach ($result as $row) {
                        ...
                        $viewButton = "<a href='other_mid_role_edit_event.php?id={$row['event_id']}&username={$row['username']}' class='edit-button'>View</a>";
